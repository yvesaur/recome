...
mf_model = NewsMF.load_from_checkpoint(checkpoint_path="./api/model_news.ckpt", num_users=len(ind2user) + 1, num_items=len(ind2item) + 1, dim = 50)
...
def getNewsData(request):
    ...
    return Response(most_sim.head(1))
